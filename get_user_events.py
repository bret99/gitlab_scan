        ...
        while 1:
            ...
            for item in user:
                if user[item_counter]["action_name"].startswith("push"):
                    item = "project_id: " + str(user[item_counter]["project_id"]) + " action_name: " + str(user[item_counter]["action_name"]) + " created_at: " + str(user[item_counter]["created_at"]) + " push_action: " + str(user[item_counter]["push_data"]["action"]) + " ref_type: " + str(user[item_counter]["push_data"]["ref_type"]) + " ref: " + str(user[item_counter]["push_data"]["ref"]) + " commit_title: " + str(user[item_counter]["push_data"]["commit_title"])
                    events_list.append(item)
                    item_to_print = "\033[1;94mproject_id\033[1;00m: \033[1;92m" + str(user[item_counter]["project_id"]) + " \033[1;94maction_name\033[1;00m: \033[1;92m" + str(user[item_counter]["action_name"]) + " \033[1;94mcreated_at\033[1;00m: \033[1;92m" + str(user[item_counter]["created_at"]) + " \033[1;94mpush_action\033[1;00m: \033[1;92m" + str(user[item_counter]["push_data"]["action"]) + " \033[1;94mref_type\033[1;00m: \033[1;92m" + str(user[item_counter]["push_data"]["ref_type"]) + " \033[1;94mref\033[1;00m: \033[1;92m" + str(user[item_counter]["push_data"]["ref"]) + " \033[1;94mcommit_title\033[1;00m: \033[1;92m" + str(user[item_counter]["push_data"]["commit_title"]) + "\033[1;00m"
                    events_to_print_list.append(item_to_print)
                else:
                    item = "project_id: " + str(user[item_counter]["project_id"]) + " action_name: " + str(user[item_counter]["action_name"]) + " created_at: " + str(user[item_counter]["created_at"])
                    events_list.append(item)
                    item_to_print = "\033[1;94mproject_id\033[1;00m: \033[1;92m" + str(user[item_counter]["project_id"]) + " \033[1;94maction_name\033[1;00m: \033[1;92m" + str(user[item_counter]["action_name"]) + " \033[1;94mcreated_at\033[1;00m: \033[1;92m" + str(user[item_counter]["created_at"]) + "\033[1;00m"
                    events_to_print_list.append(item_to_print)
